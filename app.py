...
class Deepfake:
    def __init__(self):
        ...
        self.checkpoint = torch.load("DeepFakeDetection-master\\__pycache__\\resnetinceptionv1_epoch_32.pth", map_location=torch.device('cpu'))
...
def get_hours():
	if request.method == 'POST':
		...
		img_path=os.path.join("DeepFakeDetection-master\static","image.jpg")
		img.save(img_path)
